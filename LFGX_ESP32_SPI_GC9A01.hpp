/*
  This file is based on a sample program by Uruka Technology:
    https://github.com/urukakanko/M5StampS3_round_lcd-/blob/main/M5stampS3_ClockSample/M5stampS3_ClockSample.ino
*/

#ifndef LFGX_ESP32_SPI_GC9A01_HPP
#define LFGX_ESP32_SPI_GC9A01_HPP
...
public:
  LGFX_ESP32_SPI_GC9A01(int W, int H)
  {
    { // バス制御の設定を行います。
...
#endif /* LFGX_ESP32_SPI_GC9A01_HPP */
